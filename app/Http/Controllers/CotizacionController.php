...
use App\Application\UseCases\Cotizacion\GetCotizacionesAnuladasUseCase; 
use App\Application\UseCases\Cotizacion\GetCotizacionByIdUseCase;
use App\Application\UseCases\Cotizacion\CountCotizacionesActivasUseCase;
...
class CotizacionController extends Controller
{
    ...
    public function anuladas(GetCotizacionesAnuladasUseCase $useCase): JsonResponse
    {
        return response()->json($useCase->execute());
    }
    ...
    public function countActivas(CountCotizacionesActivasUseCase $useCase): JsonResponse
    {
        $total = $useCase->execute();
        
        return response()->json([
            'total_activos' => $total,
            'message' => 'Total de cotizaciones activas obtenido correctamente'
        ]);
    }
}